...
ログラスではドメイン駆動設計(DDD)と関数型プログラミングを導入しており、現在は「[関数型ドメインモデリング](https://asciidwango.jp/post/754242099814268928/%E9%96%A2%E6%95%B0%E5%9E%8B%E3%83%89%E3%83%A1%E3%82%A4%E3%83%B3%E3%83%A2%E3%83%87%E3%83%AA%E3%83%B3%E3%82%B0)」という本の輪読会[^1]を実施しています。
...
関数の内部にローカル変数と関数の定義を含めることができます。また、コンパイラは関数本体の最後の式を使用して戻り値とその型を特定します。
...
`match...with`を用いることで、パターンマッチングによる条件分岐を実現できます。関数プログラミングでは、Result型とパターンマッチングを組み合わせて処理を組み立ていくケースが多いです。
